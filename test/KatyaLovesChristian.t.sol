...
contract KatyaLovesChristianTest is Test {
    ...
    function test_doesKatyaLovesChristianTRUE() public {
        assertEq(keccak256(abi.encodePacked(katyaLovesChristian.doesKatyaLoveChristian(true))), keccak256(abi.encodePacked("Yes, Katya loves Christian")));
    }
    ...
    function test_doesKatyaLovesChristianFALSE() public {
        assertEq(keccak256(abi.encodePacked(katyaLovesChristian.doesKatyaLoveChristian(false))), keccak256(abi.encodePacked("Yes, Katya loves Christian but her typing is a bit retarded at the moment")));
    }
